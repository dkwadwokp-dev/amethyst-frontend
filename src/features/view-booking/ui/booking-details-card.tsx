  ...
  return (
    <Section className="bg-[#F8F9FA]">
      <div className="max-w-6xl mx-auto mb-8 text-center">
        <h2 className="text-xl md:text-2xl font-marcellus text-gray-900">
      ...
      <div className="max-w-5xl mx-auto space-y-4 md;space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {/* Reservation Info */}
          <div className="bg-white p-4 md:p-8 shadow-sm border border-gray-100 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-6">
                <span className="bg-green-100 text-green-800 text-[10px] font-bold tracking-widest px-3 py-1  uppercase">
                  Confirmed
                </span>
          ...
          <div className="bg-white p-4 md:p-8 shadow-sm border border-gray-100">
            ...
            <div className="flex flex-wrap gap-4 mb-4 text-[10px] text-gray-500 font-bold tracking-widest uppercase">
              <span className="flex items-center gap-1">
                <Bed className="w-3 h-3" /> 1 KING BED
              </span>
              <span className="flex items-center gap-1">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Spacious luxury suite featuring a separate living area, stunning
              city views, and premium bathroom amenities to ensure a comfortable
              stay.
            </p>
          </div>

          {/* Contact & Policies */}
          <div className="bg-white p-4 md:p-8 shadow-sm border border-gray-100 flex flex-col">
            <div className="mb-8">
