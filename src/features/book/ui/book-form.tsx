...
const BookForm = () => {
  ...
  const [selectedDiningArea, setSelectedDiningArea] = useState(
    diningAreas[0].id,
  );
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="text"
              className="w-full border-b border-gray-200 p-2 text-gray-900 text-sm focus:outline-none focus:border-gray-900 bg-transparent placeholder:text-gray-300"
