            ...
            <div className="flex-1 py-4 flex flex-col md:flex-row justify-between gap-6 h-full">
              ...
              <div className="flex flex-col items-start md:items-end justify-between md:w-32 shrink-0 border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6 text-right">
                ...
                <div className="w-full mt-6 md:mt-0 flex flex-col items-start md:items-end justify-end flex-1">
                  <Link to={`/book?room=${room.id}`} className="w-full block mb-3">
                    <Button
                      variant="primary"
                  ...
                  <Link to={`/rooms/${room.id}`} className="text-[10px] text-gray-500 uppercase tracking-widest hover:text-gray-900 cursor-pointer text-center w-full md:text-right">
                    VIEW DETAILS
                  </Link>
                </div>
              </div>
