    ...
    <div className="min-h-screen bg-[#F8F9FA] font-manrope">
      ...
      {isRoomPending && (
        <motion.div
          ...
          className="bg-orange-50 border-b border-orange-100 py-3 md:py-4 px-4 sticky top-[64px] z-40"
        >
          <div className="max-w-6xl mx-auto flex items-center justify-center gap-3 text-orange-800 text-[10px] md:text-xs font-bold tracking-widest uppercase text-center">
